...
async def start(callback_query: types.CallbackQuery):
    await bot.send_message(callback_query.message.chat.id, f'✏ Доступные шрифты:\n1️⃣ <code>minecraft</code>\n2️⃣ <code>neon</code>\n3️⃣ <code>evil</code>\n4️⃣ <code>gaffuk</code>\n5️⃣ <code>comic</code>\n6️⃣ <code>gagalin</code>\n7️⃣ <code>lettera</code>\n8️⃣ <code>tribute</code>\n9️⃣ <code>marvin</code>\n🔟 <code>patsy</code>', parse_mode='html', reply_markup=kb.download_font)
...
async def font_1(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_1, caption=f'🚀 Держи!')
...
async def font_2(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_2, caption=f'🚀 Держи!')
...
async def font_3(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_3, caption=f'🚀 Держи!')
...
async def font_4(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_4, caption=f'🚀 Держи!')
...
async def font_5(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_5, caption=f'🚀 Держи!')
...
async def font_6(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_6, caption=f'🚀 Держи!')
...
async def font_7(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_7, caption=f'🚀 Держи!')
...
async def font_8(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_8, caption=f'🚀 Держи!')
...
async def font_9(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_9, caption=f'🚀 Держи!')
...
async def font_10(callback_query: types.CallbackQuery):
    ...
    await bot.send_document(chat_id=callback_query.message.chat.id, document=get_font_10, caption=f'🚀 Держи!')
